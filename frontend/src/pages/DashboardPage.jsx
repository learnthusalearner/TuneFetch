  ...
  const handleImportSessionSubmit = async (e) => {
    ...
    try {
      ...
      if (trimmed.startsWith('[') && trimmed.endsWith(']')) {
        ...
        pushToast(`Imported ${parsedTracks.length} songs! Downloading to your Downloads/TuneFetch folder...`, 'success');
        setSessionInput('');
        return;
      }
      ...
      setLocalBatchId(data.batch_id);
      pushToast(`Loaded session ${code} (${data.total_tracks} tracks)! Downloading on your PC...`, 'success');
      setSessionInput('');
    } catch (err) {
