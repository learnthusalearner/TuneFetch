 ...
 * Supports step-by-step live simulation playback or full static display.
 */
export default function TuneFetchTerminal({
  ...
  // If simStep is null or undefined, show all stages (default for modals or static previews)
  const currentStep = simStep !== null && simStep !== undefined ? simStep : 6;
  ...
  return (
    ...
    >
      ...
      >
        {/* Prompt Line (Step 0+) */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: currentStep > 0 ? '16px' : '0px', flexWrap: 'wrap' }}>
        ...
        {/* Modern Rounded Box Banner (Step 1+) */}
        {currentStep >= 1 && (
...
{` ╭────────────────────────────────────────────────────────────╮
 ...
 ╰────────────────────────────────────────────────────────────╯`}
        ...
        {/* Stage 1 & 2: Resolving & Verified (Step 2+) */}
        {currentStep >= 2 && (
          <>
        ...
        {/* Track 2: Downloading Progress (Step 4 only) */}
        {currentStep === 4 && (
          <div style={{ marginBottom: '20px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px', marginBottom: '6px' }}>
              ...
              <span style={{ fontSize: '12.5px' }}>
                <strong style={{ color: '#1db954' }}>64%</strong>{' '}
                <span style={{ color: '#475569' }}>|</span>{' '}
                <strong style={{ color: '#facc15' }}>9.4 MB/s</strong>{' '}
                <span style={{ color: '#475569' }}>|</span>{' '}
                <span style={{ color: '#38bdf8' }}>ETA: 00:02</span>
              </span>
            </div>
            {/* Visual Progress Bar */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', paddingLeft: '14px' }}>
              ...
              <span style={{ color: '#475569' }}>]</span>
              <span style={{ color: '#1db954', fontWeight: 700 }}>64%</span>
            </div>
          </div>
        )}

        {/* Track 2: Completed (Step 5+) */}
        {currentStep >= 5 && (
          <div style={{ marginBottom: '14px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
              <span style={{ color: '#ffffff' }}>
        ...
        {/* Track 3: Downloading Progress (Step 5 only) */}
        {currentStep === 5 && (
          <div style={{ marginBottom: '20px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px', marginBottom: '6px' }}>
              <span style={{ color: '#ffffff' }}>
              ...
              <span style={{ fontSize: '12.5px' }}>
                ...
                <span style={{ color: '#475569' }}>|</span>{' '}
                <strong style={{ color: '#facc15' }}>11.2 MB/s</strong>{' '}
                <span style={{ color: '#475569' }}>|</span>{' '}
        ...
        {/* Track 3 Completed & Modern Completion Card (Step 6+) */}
        {currentStep >= 6 && (
          <>
            <div style={{ marginBottom: '14px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
